...
#define CONFIG_GNSS_FONT           u8g2_font_siji_t_6x10 // u8g2_font_waffle_t_all
...
void feedGNSS(bool vaild)
{
    CLEAR_AREA(96,
               32,
               32,
               18);
    u8g2.setFont(CONFIG_GNSS_FONT);
    if (vaild) {
        u8g2.drawGlyph(96 + 20, 32 + 14, 0xE0AB);
        u8g2.setFont(u8g2_font_nokiafc22_tr);
        u8g2.drawStr(96, 48 - 4, "3D");
    } else {
        u8g2.setFont(u8g2_font_nokiafc22_tr);
        u8g2.drawStr(96, 48 - 4, "No fix");
    }
}

void feedSD(bool vaild, float mb)
{
    CLEAR_AREA(96,
               48,
               32,
    ...
    if (vaild) {
        u8g2.setFont(u8g2_font_nokiafc22_tr);
        if (mb != 0 && mb < 1) {
            String valString = String((int)(mb * 1000)) + "M";
            u8g2.drawStr(96, 64 - 4, valString.c_str());
        } else {
            String valString = String((int)mb) + "G";
            u8g2.drawStr(96, 64 - 4, valString.c_str());
            u8g2.setFont(u8g2_font_siji_t_6x10);
            u8g2.drawGlyph(96 + 20, 64 - 4, 0xE120);
        }
    } else {
        u8g2.setFont(u8g2_font_siji_t_6x10);
        u8g2.drawGlyph(96 + 20, 64 - 4, 0xE0AE);
        u8g2.setFont(u8g2_font_nokiafc22_tr);
        u8g2.drawStr(98, 64 - 4, "--");
    }
}
...
void feedElectricity(uint8_t percentage)
{
    ...
    if (vbusIn ) {
        u8g2.drawGlyph(96 + 16 + 4, 16 - 2, 0xe200);
    } else {
        if (percentage >= 60) {
...
void feedSettingsPage()
{
    ...
    feedSettingsPagebarPower(false);
...
void feedSettingsPagebarPower(bool select)
{
    CLEAR_AREA(CONFIG_SETTINGS_PAGE_BAR_BD_BOX_X,
               CONFIG_SETTINGS_PAGE_BAR_BD_BOX_Y,
               CONFIG_SETTINGS_PAGE_BAR_BD_BOX_W,
    ...
    u8g2.drawStr(CONFIG_SETTINGS_PAGE_BAR_BD_TEXT_X, CONFIG_SETTINGS_PAGE_BAR_BD_TEXT_Y, "Power");
}


void feedSettingsPagebarPowerPageTitle();

void feedSettingsPagebarPowerPage()
{
    // feedSettingsPagebarPowerPageBar1();
    CLEAR_AREA(CONFIG_SETTINGS_PAGE_X,
               CONFIG_SETTINGS_PAGE_Y,
               CONFIG_SETTINGS_PAGE_W,
               CONFIG_SETTINGS_PAGE_H);
    feedSettingsPagebarPowerPageTitle();
}
...
void feedSettingsPagebarPowerPageBar1(bool select/*, bool enable*/)
{
    CLEAR_AREA(CONFIG_SETTINGS_PAGE_BAR_BD_BOX_X,
               CONFIG_SETTINGS_PAGE_BAR_BD_BOX_Y,
               CONFIG_SETTINGS_PAGE_BAR_BD_BOX_W,
    ...
    if (select) {
        ...
        u8g2.drawBox((CONFIG_SETTINGS_PAGE_BAR_BD_BOX_X + \
                     ...
                     (CONFIG_SETTINGS_PAGE_BAR_BD_BOX_H - \
                      ...
                      CONFIG_SETTINGS_PAGE_BAR_BD_MARGIN_TOP));
        u8g2.setDrawColor(0x00);
        u8g2.drawStr(CONFIG_SETTINGS_PAGE_BAR_BD_TEXT_X, CONFIG_SETTINGS_PAGE_BAR_BD_TEXT_Y, "* Low");
    } else {
        u8g2.setDrawColor(0x00);
        u8g2.drawBox((CONFIG_SETTINGS_PAGE_BAR_BD_BOX_X + \
                      CONFIG_SETTINGS_PAGE_BAR_BD_MARGIN_LEFT),
...
void feedSettingsPagebarPowerPageBar2(bool select/*, bool enable*/)
{
    CLEAR_AREA(CONFIG_SETTINGS_PAGE_BAR_TF_BOX_X,
               CONFIG_SETTINGS_PAGE_BAR_TF_BOX_Y,
               CONFIG_SETTINGS_PAGE_BAR_TF_BOX_W,
    ...
    if (select) {
        ...
        u8g2.drawBox((CONFIG_SETTINGS_PAGE_BAR_TF_BOX_X + \
                     ...
                     (CONFIG_SETTINGS_PAGE_BAR_TF_BOX_H - \
                      ...
                      CONFIG_SETTINGS_PAGE_BAR_TF_MARGIN_TOP));
        u8g2.setDrawColor(0x00);
        u8g2.drawStr(CONFIG_SETTINGS_PAGE_BAR_TF_TEXT_X, CONFIG_SETTINGS_PAGE_BAR_TF_TEXT_Y, "* High");
    } else {
        u8g2.setDrawColor(0x00);
        u8g2.drawBox((CONFIG_SETTINGS_PAGE_BAR_TF_BOX_X + \
                      CONFIG_SETTINGS_PAGE_BAR_TF_MARGIN_LEFT),
